    ...
    <div className="space-y-4 rounded-lg border bg-muted/20 p-3 md:p-4">
      <div className="grid gap-3 md:grid-cols-3">
        <div className="min-w-0 space-y-2">
          <Label className="text-xs" htmlFor="tp-panel-channel">
            Panel channel
          </Label>
          <select
            id="tp-panel-channel"
        ...
        <div className="min-w-0 space-y-2">
          <Label className="text-xs" htmlFor="tp-category">
            Ticket category
          </Label>
          <select
            id="tp-category"
        ...
        <div className="min-w-0 space-y-2">
          <Label className="text-xs" htmlFor="tp-transcript">
            Transcript channel
          </Label>
          <select
            id="tp-transcript"
        ...
        <div className="min-w-0 space-y-2">
          <Label className="text-xs" htmlFor="tp-panel-emoji">
            Embed emoji
          </Label>
          <Input
            id="tp-panel-emoji"
        ...
        <div className="min-w-0 space-y-2 md:col-span-2">
          <Label className="text-xs" htmlFor="tp-panel-title">
            Panel title
          </Label>
          <MarkdownEditor
            id="tp-panel-title"
        ...
        <div className="min-w-0 space-y-2 md:col-span-3">
          <Label className="text-xs" htmlFor="tp-panel-description">
            Panel description
          </Label>
          <MarkdownEditor
        ...
        <div className="min-w-0 space-y-2 md:col-span-3">
          <Label className="text-xs" htmlFor="tp-panel-footer">
            Panel footer
          </Label>
          <Input
            id="tp-panel-footer"
          ...
          <p className="text-[11px] text-muted-foreground">
            Discord renders the embed footer as plain text.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0">
            ...
            <p className="text-xs text-muted-foreground">
              {value.ticketTypes.length} configured. Open one type at a time when you need the
              details.
            </p>
          </div>
            ...
            {value.ticketTypes.length > 0 ? (
              <>
                <Button
                  ...
                  variant="ghost"
                  onClick={() =>
                    setOpenTicketTypes(new Set(value.ticketTypes.map(getTicketTypeKey)))
                  }
                >
                  Expand all
                </Button>
            ...
            {value.ticketTypes.map((ticketType, ticketTypeIndex) => {
              ...
              return (
                <details
                  ...
                  open={ticketTypeOpen}
                  onToggle={(event) => setTicketTypeOpen(ticketTypeKey, event.currentTarget.open)}
                >
                  <summary className="flex cursor-pointer list-none items-center justify-between gap-3 px-3 py-2 marker:hidden">
                    <div className="min-w-0">
                      ...
                      <p className="truncate text-xs text-muted-foreground">
                        {supportRoleName ? `Role: ${supportRoleName}` : "No support role"} ·{" "}
                        {ticketType.questions.length} question
                        {ticketType.questions.length === 1 ? "" : "s"}
                      </p>
                    </div>
                  ...
                  <div className="space-y-3 border-t p-3">
                    <div className="flex justify-end">
                      <Button
                        ...
                        onClick={() =>
                          onChange({
                            ...value,
                            ticketTypes: value.ticketTypes.filter(
                              (_, index) => index !== ticketTypeIndex,
                            ),
                          })
                        }
                      >
                    ...
                    <div className="grid gap-3 md:grid-cols-3">
                      <div className="space-y-2">
                        <Label className="text-xs" htmlFor={`tp-ticket-label-${ticketTypeIndex}`}>
                          Ticket type label
                        </Label>
                        <Input
                      ...
                      <div className="space-y-2">
                        <Label className="text-xs" htmlFor={`tp-ticket-id-${ticketTypeIndex}`}>
                          ID
                        </Label>
                        <Input
                      ...
                      <div className="space-y-2">
                        <Label className="text-xs" htmlFor={`tp-ticket-prefix-${ticketTypeIndex}`}>
                          Channel prefix
                        </Label>
                        <Input
                      ...
                      <div className="space-y-2">
                        <Label className="text-xs" htmlFor={`tp-ticket-emoji-${ticketTypeIndex}`}>
                          Emoji
                        </Label>
                        <Input
                      ...
                      <div className="space-y-2">
                        <Label className="text-xs" htmlFor={`tp-ticket-style-${ticketTypeIndex}`}>
                          Button style
                        </Label>
                        <select
                      ...
                      <div className="space-y-2">
                        <Label
                          className="text-xs"
                          htmlFor={`tp-ticket-support-role-${ticketTypeIndex}`}
                        >
                          Support role
                        </Label>
                        <select
                        ...
                        >
                          ...
                          {ticketType.supportRoleId &&
                            !guildResources.roles.find(
                              (role) => role.id === ticketType.supportRoleId,
                            ) && (
                              <option value={ticketType.supportRoleId}>
                                {ticketType.supportRoleId}
                              </option>
                            )}
                    ...
                    <div className="space-y-2 rounded-md border border-dashed p-3">
                      ...
                      {ticketType.questions.length === 0 ? (
                        <p className="text-sm text-muted-foreground">
                          No questions configured yet. Add a question to collect ticket details from
                          members.
                        </p>
                      ) : (
                        <div className="space-y-2">
                              ...
                              >
                                <summary className="flex cursor-pointer list-none items-center justify-between gap-3 px-3 py-2 marker:hidden">
                                  <div className="min-w-0">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                      {question.style === "paragraph" ? "Paragraph" : "Short"} ·{" "}
                                ...
                                <div className="space-y-3 border-t p-3">
                                  ...
                                  <div className="grid gap-3 md:grid-cols-2">
                                    <div className="space-y-2">
                                      <Label
                                        className="text-xs"
                                        htmlFor={`tp-question-label-${ticketTypeIndex}-${questionIndex}`}
                                      >
                                        Question label
                                      </Label>
                                      <Input
                                    ...
                                    <div className="space-y-2">
                                      <Label
                                        className="text-xs"
                                        htmlFor={`tp-question-id-${ticketTypeIndex}-${questionIndex}`}
                                      >
                                        Question ID
                                      </Label>
                                      <Input
                                    ...
                                    <div className="space-y-2">
                                      <Label
                                        className="text-xs"
                                        htmlFor={`tp-question-style-${ticketTypeIndex}-${questionIndex}`}
                                      >
                                        Question style
                                      </Label>
                                      <select
                                    ...
                                    <div className="space-y-2">
                                      <Label
                                        className="text-xs"
                                        htmlFor={`tp-question-placeholder-${ticketTypeIndex}-${questionIndex}`}
                                      >
                                        Placeholder
                                      </Label>
                                      <Input
